...
1. [Install SLM-Lab](https://kengz.gitbooks.io/slm-lab/content/installation/installation.html) and bring along your laptop if you'd like to experience Keng and Laura's demo interactively. 
2. [CS231n Spring 2017 Lecture 14](https://www.youtube.com/watch?v=lvoHnicueoE&index=14&list=PL3FW7Lu3i5JvHM8ljYj-zLfQRF3EO8sYv) by Serena Young on Deep Reinforcement Learning (my notes on the lecture are [here](https://github.com/the-deep-learners/study-group/blob/master/weekly-work/week15/README.md))
3. In addition, you may enjoy any of the following previously-recommended resources if you haven't perused them already:
	* [Early lectures](https://www.youtube.com/watch?v=Q4kF8sfggoI&list=PLkFD6_40KJIznC9CDbVTjAF2oyt8_VAe3&index=1) from the UC Berkeley CS294-112 course
	* Andrej Karpathy's [Pong from Pixels](http://karpathy.github.io/2016/05/31/rl/) blog post
	* Kai Arulkumaran and colleagues' [arXiv review paper](https://arxiv.org/abs/1708.05866)
	* Chapter 16 from Aurélien Géron's [Hands-on Machine Learning book](http://shop.oreilly.com/product/0636920052289.do)
